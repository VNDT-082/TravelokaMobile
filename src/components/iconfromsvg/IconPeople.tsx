...
export default function IconPeople(props: IPops) {
    const { height, width } = props
    return (
        <Svg width={width} height={height} viewBox="0 0 24 24" data-id="IcSystemGuestPassenger" ><G fill="none" fill-rule="evenodd"><rect width="24" height="24"></rect>
